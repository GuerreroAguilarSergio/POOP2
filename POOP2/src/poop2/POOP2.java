...
public class POOP2 {
    ...
    public static void main(String[] args) {
        ...
        switch (vocal) {
            case 'a':
                System.out.println("La vocal es _a_");
                break;
            case 'e':
                System.out.println("La vocal es _e_");
                break;
            case 'i':
                System.out.println("La vocal es _i_");
                break;
            case 'o':
                System.out.println("La vocal es _o_");
                break;
            case 'u':
                System.out.println("La vocal es _u_");
                break;
            default:
